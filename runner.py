...
class Runner(BoxLayout):
    ...
    def __init__(self, total=10, steptime=1, autorepeat=True, bcolor=(0.74, 0.19, 0.82, 1), btext_inprogress="Приседание", **kwargs):
        ...
        self.btn = Button(background_color=(0.74, 0.19, 0.82, 1), size_hint=(1, 0.1), pos_hint={"top":1.0})
